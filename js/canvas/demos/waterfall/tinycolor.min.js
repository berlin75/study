!function() {
    ...
    function e(t) {
        ...
        "object" == typeof t && (t.hasOwnProperty("r") && t.hasOwnProperty("g") && t.hasOwnProperty("b") ? (e = r(t.r, t.g, t.b),
        i = !0,
        o = "%" === String(t.r).substr(-1) ? "prgb" : "rgb") : t.hasOwnProperty("h") && t.hasOwnProperty("s") && t.hasOwnProperty("v") ? (t.s = O(t.s),
        t.v = O(t.v),
        e = s(t.h, t.s, t.v),
        i = !0,
        o = "hsv") : t.hasOwnProperty("h") && t.hasOwnProperty("s") && t.hasOwnProperty("l") && (t.s = O(t.s),
        t.l = O(t.l),
        e = a(t.h, t.s, t.l),
        i = !0,
        o = "hsl"),
    ...
    function g(e, r) {
        r = 0 === r ? 0 : r || 10;
        var n = t(e).toRgb();
        return n.r = $(0, T(255, n.r - j(255 * -(r / 100)))),
        n.g = $(0, T(255, n.g - j(255 * -(r / 100)))),
        n.b = $(0, T(255, n.b - j(255 * -(r / 100)))),
        t(n)
    }
    function d(e, r) {
        r = 0 === r ? 0 : r || 10;
    ...
    function w(e, r) {
        r = r || 6;
        for (var n = t(e).toHsv(), a = n.h, i = n.s, s = n.v, o = [], f = 1 / r; r--; )
            o.push(t({
                h: a,
                s: i,
                v: s
    ...
    t.prototype = {
        ...
        getLuminance: function() {
            ...
            e = s.g / 255,
            r = s.b / 255,
            n = .03928 >= t ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4),
            a = .03928 >= e ? e / 12.92 : Math.pow((e + .055) / 1.055, 2.4),
            i = .03928 >= r ? r / 12.92 : Math.pow((r + .055) / 1.055, 2.4),
            .2126 * n + .7152 * a + .0722 * i
        },
        setAlpha: function(t) {
            return this._a = k(t),
            this._roundA = j(100 * this._a) / 100,
    ...
    t.fromRatio = function(e, r) {
        if ("object" == typeof e) {
            var n = {};
            for (var a in e)
                e.hasOwnProperty(a) && (n[a] = "a" === a ? e[a] : O(e[a]));
            e = n
        }
        return t(e, r)
    }
    ...
    t.mostReadable = function(e, r, n) {
        ...
        for (var u = 0; u < r.length; u++)
            a = t.readability(e, r[u]),
            a > h && (h = a,
            f = t(r[u]));
        return t.isReadable(e, f, {
            level: s,
            size: o
        }) || !i ? f : (n.includeFallbackColors = !1,
        t.mostReadable(e, ["#fff", "#000"], n))
    }
    ;
    var B = t.names = {
        aliceblue: "f0f8ff",
